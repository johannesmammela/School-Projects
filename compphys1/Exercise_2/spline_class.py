...
"""
Add below basis functions p1,p2,q1,q2 as defined in the lectures
"""
def p1(t):
    return (1+2*t)*(t-1)**2
...
def init_1d_spline(x,f,h):
    """
    Computes first derivatives at grid points using complete boundary conditions.
    Solves tridiagonal system for spline derivatives (fx).
    """
...
class spline:
    ...
    def __init__(self,*args,**kwargs):
        """
        Initialize 1D, 2D, or 3D Hermite cubic spline.
        Computes derivatives along each axis for interpolation.
        """
        ...
        if (self.dims==1):
            ...
            # Computes derivatives along x and y axes. Uses 1D spline three times
...
def test1d():
    # 1d example
    # 1D Test Function: interpolate sine function
